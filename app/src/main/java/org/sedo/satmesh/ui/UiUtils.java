...
public class UiUtils {
	...
	/**
	 * Retrieves the default {@link SharedPreferences} instance for the application.
	 * This instance uses a the private mode ({@link Context#MODE_PRIVATE}), ensuring that these
	 * preferences are only accessible by the calling application.
	 *
	 * @param context The context used to access SharedPreferences. Must not be null.
	 * @return The application's default {@link SharedPreferences} instance.
	 */
