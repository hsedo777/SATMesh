                    ...
                    .setPositiveButton(R.string.yes, (dialog, which) -> {
                        if (serviceStatus.needToDisableBluetooth()) {
                            ...
                            try {
                                ...
                                if (!success) {
                                    ...
                                    Log.d(TAG, "Start bluetooth settings activity on app exiting because `BluetoothAdapter.disable`is not responded.");
                                } else {
                                    Log.d(TAG, "Bluetooth disabled directly on app exiting.");
                                }
                        ...
                        if (serviceStatus.needToDisableWifi()) {
                            ...
                            try {
                                ...
                                if (!success) {
                                    startActivity(intent);
                                    Log.d(TAG, "Start wifi settings activity on app exiting because `WifiManager.setWifiEnabled`is not responded.");
                                } else {
                                    Log.d(TAG, "Wifi disabled on app exiting.");
                                }
                            } catch (SecurityException | NullPointerException e) {
                                startActivity(intent);
